...
export default function LoginForm() {
  ...
  return (
    <main className='flex grid md:grid-cols-2 max-w-6xl mx-auto'>
        <section className='w-4/5 mx-auto'>
        <lottie-player src="https://lottie.host/183bd6e3-440e-46bd-9140-2b93f2e66354/imqbdtmDDU.json" background="#FFFFFF" speed="1" loop autoplay direction="1" mode="normal"></lottie-player>
        </section>
