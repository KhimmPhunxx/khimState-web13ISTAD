...
export default function Profile() {
  ...
  return (
    <main>
       {
        islogin ? 
           <section className='max-w-xl p-5 rounded-xl mx-auto mt-10 bg-slate-700' >
            <div className=''>
                <img src={profile && profile.avatar} className='h-40 rounded-full' alt="" />
                <div>
                    {/* <i class="fa-solid fa-certificate text-blue-500"></i> */}
                    <h1 className='text-3xl text-gray-300 font-bold ml-8'>{profile && profile.name}  
                    <i class="fa-solid fa-certificate text-blue-500 ml-2"></i>
                    </h1> 
                    
                </div>
                <p className="dark:text-gray-500 text-black text-lg mx-auto fs-5 text-muted mt-2">
                  <h1 className='font-semibold text-gray-400 float-left mr-3'>ID: </h1>{profile && profile.id}
                </p>
                <p className="dark:text-gray-500 text-black text-lg mx-auto fs-5 text-muted mt-1">
                  <h1 className='font-semibold text-gray-400 float-left mr-3'>Email Addregulars: </h1>{profile && profile.email}
                </p>
                <p className="dark:text-gray-500 text-black text-lg mx-auto fs-5 text-muted mt-1">
                  <h1 className='font-semibold text-gray-400 float-left mr-3'> Password: </h1>{profile && profile.password}
                </p>
                <p className="dark:text-gray-500 text-black text-lg mx-auto fs-5 text-muted mt-1">
                  <h1 className='font-semibold text-gray-400 float-left mr-3'> Role: </h1>{profile && profile.role}
                </p>
        ...
        <section className='max-w-xl p-5 rounded-xl mx-auto mt-10 bg-slate-700'>
            <div className=''>
                ...
                <h1 className='text-2xl text-gray-300 font-bold'>Profile don't Login!!</h1> 
                <p className="dark:text-gray-500 text-black text-lg mx-auto fs-5 text-muted mt-2">
