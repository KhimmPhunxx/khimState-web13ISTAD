...
export default function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-10">      
            <nav class="e bg-blue-200 border-gray-200 dark:bg-opacity-95 dark:bg-gray-900 border-y border-gray-200 dark:border-gray-700">
            ...
            type="button" 
            class="drop-shadow-lg text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
            Insert
            </button>
            <button 
            onClick={()=> islogin ? dispatch(logoutUser()) : navigate("loginform")}
            type="button" 
            class="drop-shadow-lg text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
                {
